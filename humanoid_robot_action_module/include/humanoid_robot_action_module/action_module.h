...
private:
  ...
  bool
  isRunningServiceCallback(humanoid_robot_action_module_msgs::IsRunning::Request &req,
                           humanoid_robot_action_module_msgs::IsRunning::Response &res);

  void pageNumberCallback(const std_msgs::Int32::ConstPtr &msg);
  void
  startActionCallback(const humanoid_robot_action_module_msgs::StartAction::ConstPtr &msg);
