...
void ActionModule::initialize(const int control_cycle_msec,
  ...
  std::string path =
      ros::package::getPath("humanoid_robot_action_module") + "/data/motion_4095.bin";
...
bool ActionModule::isRunningServiceCallback(
    humanoid_robot_action_module_msgs::IsRunning::Request &req,
    humanoid_robot_action_module_msgs::IsRunning::Response &res) {
...
void ActionModule::startActionCallback(
    const humanoid_robot_action_module_msgs::StartAction::ConstPtr &msg) {
  if (enable_ == false) {
    std::string status_msg = "Action Module is not enabled";
    ROS_INFO_STREAM(status_msg);
    publishStatusMsg(humanoid_robot_controller_msgs::StatusMsg::STATUS_ERROR,
