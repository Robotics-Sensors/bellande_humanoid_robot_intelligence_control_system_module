...
class DirectControlModule
    : public humanoid_robot_intelligence_control_system_framework::MotionModule,
      public humanoid_robot_intelligence_control_system_framework::Singleton<DirectControlModule> {
public:
  DirectControlModule();
...
private:
  ...
  Eigen::MatrixXd calcMinimumJerkTraPVA(double pos_start, double vel_start,
  ...
  HUMANOID_ROBOTKinematicsDynamics *humanoid_robot_intelligence_control_system_kinematics_;
};
