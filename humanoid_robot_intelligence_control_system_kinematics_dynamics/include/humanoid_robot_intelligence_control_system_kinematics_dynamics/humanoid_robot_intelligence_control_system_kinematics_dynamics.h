...
#include "link_data.h"
#include "humanoid_robot_intelligence_control_system_kinematics_dynamics_define.h"
...
public:
  ...
  LinkData *humanoid_robot_intelligence_control_system_link_data_[ALL_JOINT_ID + 1];
