...
{
  ros::init(argc, argv, "humanoid_robot_intelligence_control_system_manager");
  ros::NodeHandle nh;
  ...
  ros::Subscriber button_sub = nh.subscribe("/humanoid_robot_intelligence_control_system/open_cr/button", 1, buttonHandlerCallback);
  ros::Subscriber dxl_torque_sub = nh.subscribe("/humanoid_robot_intelligence_control_system/dxl_torque", 1, dxlTorqueCheckCallback);
  g_init_pose_pub = nh.advertise<std_msgs::String>("/humanoid_robot_intelligence_control_system/base/ini_pose", 0);
