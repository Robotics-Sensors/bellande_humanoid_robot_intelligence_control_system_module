...
#include "humanoid_robot_intelligence_control_system_tuning_module_msgs/GetPresentJointOffsetData.h"
#include "humanoid_robot_intelligence_control_system_tuning_module_msgs/JointOffsetData.h"
#include "humanoid_robot_intelligence_control_system_tuning_module_msgs/JointTorqueOnOffArray.h"
...
class TuningModule : public humanoid_robot_intelligence_control_system_framework::MotionModule,
                     public humanoid_robot_intelligence_control_system_framework::Singleton<TuningModule> {
public:
  TuningModule();
