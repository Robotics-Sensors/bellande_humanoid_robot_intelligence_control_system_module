...
WholebodyControl::WholebodyControl(std::string control_group, double init_time,
                                   double fin_time,
  ...
  Eigen::Quaterniond goal_task_Q(
      goal_msg_.orientation.w, goal_msg_.orientation.x, goal_msg_.orientation.y,
...
void WholebodyControl::initialize(std::vector<double_t> init_body_pos,
  ...
  Eigen::Quaterniond body_Q(init_body_rot[3], init_body_rot[0],
                            init_body_rot[1], init_body_rot[2]);
  init_body_Q_ = body_Q;
  des_body_Q_ = body_Q;
  ...
  if (control_group_ == "body") {
    task_trajectory_ = new humanoid_robot_intelligence_control_system_framework::MinimumJerk(
...
void WholebodyControl::finalize() { delete task_trajectory_; }
