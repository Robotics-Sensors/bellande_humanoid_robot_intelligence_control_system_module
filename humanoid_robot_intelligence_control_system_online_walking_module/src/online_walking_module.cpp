...
#include "humanoid_robot_intelligence_control_system_online_walking_module/online_walking_module.h"
...
OnlineWalkingModule::OnlineWalkingModule()
    : control_cycle_sec_(0.008), is_moving_(false), is_balancing_(false),
      is_offset_updating_(false), goal_initialize_(false),
      balance_control_initialize_(false), body_offset_initialize_(false),
      joint_control_initialize_(false), wholebody_initialize_(false),
      walking_initialize_(false), is_foot_step_2d_(false), walking_phase_(DSP),
      total_mass_(3.5), foot_distance_(0.07) {
  enable_ = false;
  module_name_ = "online_walking_module";
  control_mode_ = humanoid_robot_intelligence_control_system_framework::PositionControl;
  control_type_ = NONE;
  balance_type_ = OFF;

  humanoid_robot_intelligence_control_system_kdl_ = new HUMANOID_ROBOTKinematics();

  /* leg */
  result_["r_hip_yaw"] = new humanoid_robot_intelligence_control_system_framework::DynamixelState();
  result_["r_hip_roll"] = new humanoid_robot_intelligence_control_system_framework::DynamixelState();
  result_["r_hip_pitch"] = new humanoid_robot_intelligence_control_system_framework::DynamixelState();
  result_["r_knee"] = new humanoid_robot_intelligence_control_system_framework::DynamixelState();
  result_["r_ank_pitch"] = new humanoid_robot_intelligence_control_system_framework::DynamixelState();
  result_["r_ank_roll"] = new humanoid_robot_intelligence_control_system_framework::DynamixelState();
  result_["l_hip_yaw"] = new humanoid_robot_intelligence_control_system_framework::DynamixelState();
  result_["l_hip_roll"] = new humanoid_robot_intelligence_control_system_framework::DynamixelState();
  result_["l_hip_pitch"] = new humanoid_robot_intelligence_control_system_framework::DynamixelState();
  result_["l_knee"] = new humanoid_robot_intelligence_control_system_framework::DynamixelState();
  result_["l_ank_pitch"] = new humanoid_robot_intelligence_control_system_framework::DynamixelState();
  result_["l_ank_roll"] = new humanoid_robot_intelligence_control_system_framework::DynamixelState();
  ...
  std::string balance_gain_path =
      ros::package::getPath("humanoid_robot_intelligence_control_system_online_walking_module") +
...
void OnlineWalkingModule::initialize(const int control_cycle_msec,
  ...
  // Publisher
  status_msg_pub_ = ros_node.advertise<humanoid_robot_intelligence_control_system_controller_msgs::StatusMsg>(
      "/humanoid_robot_intelligence_control_system/status", 1);
  movement_done_pub_ =
      ros_node.advertise<std_msgs::String>("/humanoid_robot_intelligence_control_system/movement_done", 1);
  goal_joint_state_pub_ = ros_node.advertise<sensor_msgs::JointState>(
      "/humanoid_robot_intelligence_control_system/online_walking/goal_joint_states", 1);
  pelvis_pose_pub_ =
      ros_node.advertise<geometry_msgs::PoseStamped>("/humanoid_robot_intelligence_control_system/pelvis_pose", 1);

  // Service
  //  get_preview_matrix_client_ =
  //  ros_node.serviceClient<humanoid_robot_intelligence_control_system_online_walking_module_msgs::GetPreviewMatrix>("/humanoid_robot_intelligence_control_system/online_walking/get_preview_matrix",
  //  0);
}
...
void OnlineWalkingModule::queueThread() {
  ...
  ros::Subscriber reset_body_sub_ =
      ros_node.subscribe("/humanoid_robot_intelligence_control_system/online_walking/reset_body", 5,
                         &OnlineWalkingModule::setResetBodyCallback, this);
  ros::Subscriber joint_pose_sub_ =
      ros_node.subscribe("/humanoid_robot_intelligence_control_system/online_walking/goal_joint_pose", 5,
                         &OnlineWalkingModule::goalJointPoseCallback, this);
  ros::Subscriber kinematics_pose_sub_ = ros_node.subscribe(
      "/humanoid_robot_intelligence_control_system/online_walking/goal_kinematics_pose", 5,
      &OnlineWalkingModule::goalKinematicsPoseCallback, this);
  ros::Subscriber foot_step_command_sub_ =
      ros_node.subscribe("/humanoid_robot_intelligence_control_system/online_walking/foot_step_command", 5,
                         &OnlineWalkingModule::footStepCommandCallback, this);
  ros::Subscriber walking_param_sub_ =
      ros_node.subscribe("/humanoid_robot_intelligence_control_system/online_walking/walking_param", 5,
                         &OnlineWalkingModule::walkingParamCallback, this);
  ros::Subscriber wholebody_balance_msg_sub = ros_node.subscribe(
      "/humanoid_robot_intelligence_control_system/online_walking/wholebody_balance_msg", 5,
      &OnlineWalkingModule::setWholebodyBalanceMsgCallback, this);
  ros::Subscriber body_offset_msg_sub =
      ros_node.subscribe("/humanoid_robot_intelligence_control_system/online_walking/body_offset", 5,
                         &OnlineWalkingModule::setBodyOffsetCallback, this);
  ros::Subscriber foot_distance_msg_sub =
      ros_node.subscribe("/humanoid_robot_intelligence_control_system/online_walking/foot_distance", 5,
                         &OnlineWalkingModule::setFootDistanceCallback, this);

  ros::Subscriber footsteps_sub =
      ros_node.subscribe("/humanoid_robot_intelligence_control_system/online_walking/footsteps_2d", 5,
                         &OnlineWalkingModule::footStep2DCallback, this);

  //  ros::Subscriber imu_data_sub =
  //  ros_node.subscribe("/humanoid_robot_intelligence_control_system/sensor/imu/imu", 5,
  //                                                    &OnlineWalkingModule::imuDataCallback,
  //                                                    this);
  //  ros::Subscriber l_foot_ft_sub =
  //  ros_node.subscribe("/humanoid_robot_intelligence_control_system/sensor/l_foot_ft", 3,
  //                                                     &OnlineWalkingModule::leftFootForceTorqueOutputCallback,
  //                                                     this);
  //  ros::Subscriber r_foot_ft_sub =
  //  ros_node.subscribe("/humanoid_robot_intelligence_control_system/sensor/r_foot_ft", 3,
  //                                                     &OnlineWalkingModule::rightFootForceTorqueOutputCallback,
  //                                                     this);

  // Service
  ros::ServiceServer get_joint_pose_server = ros_node.advertiseService(
      "/humanoid_robot_intelligence_control_system/online_walking/get_joint_pose",
      &OnlineWalkingModule::getJointPoseCallback, this);
  ros::ServiceServer get_kinematics_pose_server = ros_node.advertiseService(
      "/humanoid_robot_intelligence_control_system/online_walking/get_kinematics_pose",
...
void OnlineWalkingModule::parseBalanceGainData(const std::string &path) {
  ...
  roll_gyro_cut_off_frequency_ =
      doc["roll_gyro_cut_off_frequency"].as<double>();
  pitch_gyro_cut_off_frequency_ =
      doc["pitch_gyro_cut_off_frequency"].as<double>();

  roll_angle_cut_off_frequency_ =
      doc["roll_angle_cut_off_frequency"].as<double>();
  pitch_angle_cut_off_frequency_ =
      doc["pitch_angle_cut_off_frequency"].as<double>();

  foot_x_force_cut_off_frequency_ =
      doc["foot_x_force_cut_off_frequency"].as<double>();
  foot_y_force_cut_off_frequency_ =
      doc["foot_y_force_cut_off_frequency"].as<double>();
  foot_z_force_cut_off_frequency_ =
      doc["foot_z_force_cut_off_frequency"].as<double>();

  foot_roll_torque_cut_off_frequency_ =
      doc["foot_roll_torque_cut_off_frequency"].as<double>();
  foot_pitch_torque_cut_off_frequency_ =
      doc["foot_pitch_torque_cut_off_frequency"].as<double>();
...
void OnlineWalkingModule::parseJointFeedbackGainData(const std::string &path) {
  ...
  joint_feedback_[joint_name_to_id_["r_hip_yaw"] - 1].p_gain_ =
      doc["r_hip_yaw_p_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["r_hip_yaw"] - 1].d_gain_ =
      doc["r_hip_yaw_d_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["r_hip_roll"] - 1].p_gain_ =
      doc["r_hip_roll_p_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["r_hip_roll"] - 1].d_gain_ =
      doc["r_hip_roll_d_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["r_hip_pitch"] - 1].p_gain_ =
      doc["r_hip_pitch_p_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["r_hip_pitch"] - 1].d_gain_ =
      doc["r_hip_pitch_d_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["r_knee"] - 1].p_gain_ =
      doc["r_knee_p_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["r_knee"] - 1].d_gain_ =
      doc["r_knee_d_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["r_ank_pitch"] - 1].p_gain_ =
      doc["r_ank_pitch_p_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["r_ank_pitch"] - 1].d_gain_ =
      doc["r_ank_pitch_d_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["r_ank_roll"] - 1].p_gain_ =
      doc["r_ank_roll_p_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["r_ank_roll"] - 1].d_gain_ =
      doc["r_ank_roll_d_gain"].as<double>();

  joint_feedback_[joint_name_to_id_["l_hip_yaw"] - 1].p_gain_ =
      doc["l_hip_yaw_p_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["l_hip_yaw"] - 1].d_gain_ =
      doc["l_hip_yaw_d_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["l_hip_roll"] - 1].p_gain_ =
      doc["l_hip_roll_p_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["l_hip_roll"] - 1].d_gain_ =
      doc["l_hip_roll_d_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["l_hip_pitch"] - 1].p_gain_ =
      doc["l_hip_pitch_p_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["l_hip_pitch"] - 1].d_gain_ =
      doc["l_hip_pitch_d_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["l_knee"] - 1].p_gain_ =
      doc["l_knee_p_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["l_knee"] - 1].d_gain_ =
      doc["l_knee_d_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["l_ank_pitch"] - 1].p_gain_ =
      doc["l_ank_pitch_p_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["l_ank_pitch"] - 1].d_gain_ =
      doc["l_ank_pitch_d_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["l_ank_roll"] - 1].p_gain_ =
      doc["l_ank_roll_p_gain"].as<double>();
  joint_feedback_[joint_name_to_id_["l_ank_roll"] - 1].d_gain_ =
      doc["l_ank_roll_d_gain"].as<double>();
}
...
void OnlineWalkingModule::parseJointFeedforwardGainData(
  ...
  joint_feedforward_gain_[joint_name_to_id_["r_hip_yaw"] - 1] =
      doc["r_hip_yaw_gain"].as<double>();
  joint_feedforward_gain_[joint_name_to_id_["r_hip_roll"] - 1] =
      doc["r_hip_roll_gain"].as<double>();
  joint_feedforward_gain_[joint_name_to_id_["r_hip_pitch"] - 1] =
      doc["r_hip_pitch_gain"].as<double>();
  joint_feedforward_gain_[joint_name_to_id_["r_knee"] - 1] =
      doc["r_knee_gain"].as<double>();
  joint_feedforward_gain_[joint_name_to_id_["r_ank_pitch"] - 1] =
      doc["r_ank_pitch_gain"].as<double>();
  joint_feedforward_gain_[joint_name_to_id_["r_ank_roll"] - 1] =
      doc["r_ank_roll_gain"].as<double>();

  joint_feedforward_gain_[joint_name_to_id_["l_hip_yaw"] - 1] =
      doc["l_hip_yaw_gain"].as<double>();
  joint_feedforward_gain_[joint_name_to_id_["l_hip_roll"] - 1] =
      doc["l_hip_roll_gain"].as<double>();
  joint_feedforward_gain_[joint_name_to_id_["l_hip_pitch"] - 1] =
      doc["l_hip_pitch_gain"].as<double>();
  joint_feedforward_gain_[joint_name_to_id_["l_knee"] - 1] =
      doc["l_knee_gain"].as<double>();
  joint_feedforward_gain_[joint_name_to_id_["l_ank_pitch"] - 1] =
      doc["l_ank_pitch_gain"].as<double>();
  joint_feedforward_gain_[joint_name_to_id_["l_ank_roll"] - 1] =
      doc["l_ank_roll_gain"].as<double>();
}
...
void OnlineWalkingModule::initBalanceControl() {
  ...
  balance_tra_ = new humanoid_robot_intelligence_control_system_framework::MinimumJerk(
...
void OnlineWalkingModule::leftFootForceTorqueOutputCallback(
  ...
  Eigen::MatrixXd force_new = humanoid_robot_intelligence_control_system_framework::getRotationX(M_PI) *
                              humanoid_robot_intelligence_control_system_framework::getRotationZ(-0.5 * M_PI) *
                              force;
  Eigen::MatrixXd torque_new = humanoid_robot_intelligence_control_system_framework::getRotationX(M_PI) *
                               humanoid_robot_intelligence_control_system_framework::getRotationZ(-0.5 * M_PI) *
                               torque;
  ...
  l_foot_fx_N =
      humanoid_robot_intelligence_control_system_framework::sign(l_foot_fx_N) * fmin(fabs(l_foot_fx_N), 2000.0);
  l_foot_fy_N =
      humanoid_robot_intelligence_control_system_framework::sign(l_foot_fy_N) * fmin(fabs(l_foot_fy_N), 2000.0);
  l_foot_fz_N =
      humanoid_robot_intelligence_control_system_framework::sign(l_foot_fz_N) * fmin(fabs(l_foot_fz_N), 2000.0);
  l_foot_Tx_Nm =
      humanoid_robot_intelligence_control_system_framework::sign(l_foot_Tx_Nm) * fmin(fabs(l_foot_Tx_Nm), 300.0);
  l_foot_Ty_Nm =
      humanoid_robot_intelligence_control_system_framework::sign(l_foot_Ty_Nm) * fmin(fabs(l_foot_Ty_Nm), 300.0);
  l_foot_Tz_Nm =
      humanoid_robot_intelligence_control_system_framework::sign(l_foot_Tz_Nm) * fmin(fabs(l_foot_Tz_Nm), 300.0);
...
void OnlineWalkingModule::rightFootForceTorqueOutputCallback(
  ...
  r_foot_fx_N =
      humanoid_robot_intelligence_control_system_framework::sign(r_foot_fx_N) * fmin(fabs(r_foot_fx_N), 2000.0);
  r_foot_fy_N =
      humanoid_robot_intelligence_control_system_framework::sign(r_foot_fy_N) * fmin(fabs(r_foot_fy_N), 2000.0);
  r_foot_fz_N =
      humanoid_robot_intelligence_control_system_framework::sign(r_foot_fz_N) * fmin(fabs(r_foot_fz_N), 2000.0);
  r_foot_Tx_Nm =
      humanoid_robot_intelligence_control_system_framework::sign(r_foot_Tx_Nm) * fmin(fabs(r_foot_Tx_Nm), 300.0);
  r_foot_Ty_Nm =
      humanoid_robot_intelligence_control_system_framework::sign(r_foot_Ty_Nm) * fmin(fabs(r_foot_Ty_Nm), 300.0);
  r_foot_Tz_Nm =
      humanoid_robot_intelligence_control_system_framework::sign(r_foot_Tz_Nm) * fmin(fabs(r_foot_Tz_Nm), 300.0);
...
void OnlineWalkingModule::walkingParamCallback(
    const humanoid_robot_intelligence_control_system_online_walking_module_msgs::WalkingParam &msg) {
  walking_param_ = msg;
}

void OnlineWalkingModule::goalJointPoseCallback(
    const humanoid_robot_intelligence_control_system_online_walking_module_msgs::JointPose &msg) {
  if (enable_ == false)
    return;
...
void OnlineWalkingModule::initJointControl() {
  ...
  joint_tra_ = new humanoid_robot_intelligence_control_system_framework::MinimumJerk(
...
void OnlineWalkingModule::initOffsetControl() {
  ...
  body_offset_tra_ = new humanoid_robot_intelligence_control_system_framework::MinimumJerk(
...
void OnlineWalkingModule::goalKinematicsPoseCallback(
    const humanoid_robot_intelligence_control_system_online_walking_module_msgs::KinematicsPose &msg) {
  if (enable_ == false)
    return;
...
void OnlineWalkingModule::initWholebodyControl() {
  ...
  wholebody_control_ = new WholebodyControl(wholegbody_control_group_, ini_time,
                                            mov_time, wholebody_goal_msg_);
  ...
  if (is_moving_ == true) {
    ...
    wholebody_control_->initialize(des_body_pos_, des_body_Q_, des_r_leg_pos_,
                                   des_r_leg_Q_, des_l_leg_pos_, des_l_leg_Q_);
    is_moving_ = true;
  }
}
...
void OnlineWalkingModule::calcWholebodyControl() {
  if (is_moving_ == true) {
    ...
    wholebody_control_->getTaskPosition(des_l_leg_pos_, des_r_leg_pos_,
                                        des_body_pos_);
    wholebody_control_->getTaskOrientation(des_l_leg_Q_, des_r_leg_Q_,
                                           des_body_Q_);
...
void OnlineWalkingModule::footStep2DCallback(
    const humanoid_robot_intelligence_control_system_online_walking_module_msgs::Step2DArray &msg) {
  if (enable_ == false)
    return;
  ...
  Eigen::MatrixXd body_R =
      humanoid_robot_intelligence_control_system_framework::convertQuaternionToRotation(body_Q);
  Eigen::MatrixXd body_rpy = humanoid_robot_intelligence_control_system_framework::convertQuaternionToRPY(body_Q);
  ...
  humanoid_robot_intelligence_control_system_online_walking_module_msgs::Step2DArray foot_step_msg;

  int old_size = msg.footsteps_2d.size();
  int new_size = old_size + 3;

  humanoid_robot_intelligence_control_system_online_walking_module_msgs::Step2D first_msg;
  humanoid_robot_intelligence_control_system_online_walking_module_msgs::Step2D second_msg;
  ...
  if (control_type_ == NONE || control_type_ == WALKING_CONTROL) {
    for (int i = 0; i < old_size; i++) {
      humanoid_robot_intelligence_control_system_online_walking_module_msgs::Step2D step_msg = msg.footsteps_2d[i];
      step_msg.moving_foot -= 1;

      Eigen::MatrixXd step_R = humanoid_robot_intelligence_control_system_framework::convertRPYToRotation(
      ...
      Eigen::MatrixXd step_new_rpy =
          humanoid_robot_intelligence_control_system_framework::convertRotationToRPY(step_R_new);
    ...
    humanoid_robot_intelligence_control_system_online_walking_module_msgs::Step2D step_msg =
        msg.footsteps_2d[old_size - 1];
...
void OnlineWalkingModule::footStepCommandCallback(
    const humanoid_robot_intelligence_control_system_online_walking_module_msgs::FootStepCommand &msg) {
  if (enable_ == false)
    return;
...
void OnlineWalkingModule::initWalkingControl() {
  ...
  walking_control_ = new WalkingControl(
      control_cycle_sec_, walking_param_.dsp_ratio, walking_param_.lipm_height,
  ...
  if (get_preview_matrix == true) {
    if (is_moving_ == true) {
      ...
      if (is_foot_step_2d_ == true) {
        walking_control_->initialize(foot_step_2d_, des_body_pos_, des_body_Q_,
                                     des_r_leg_pos_, des_r_leg_Q_,
                                     des_l_leg_pos_, des_l_leg_Q_);
      } else {
        walking_control_->initialize(foot_step_command_, des_body_pos_,
                                     des_body_Q_, des_r_leg_pos_, des_r_leg_Q_,
                                     des_l_leg_pos_, des_l_leg_Q_);
      }

      walking_control_->calcPreviewParam(
          preview_response_K_, preview_response_K_row_, preview_response_K_col_,
          preview_response_P_, preview_response_P_row_,
          preview_response_P_row_);

      is_moving_ = true;

      initFeedforwardControl();

      ROS_INFO("[START] Walking Control (%d/%d)", walking_step_ + 1,
               walking_size_);
    }
...
void OnlineWalkingModule::calcWalkingControl() {
  if (is_moving_ == true) {
    ...
    walking_control_->getWalkingPosition(des_l_leg_pos_, des_r_leg_pos_,
                                         des_body_pos_);
    walking_control_->getWalkingOrientation(des_l_leg_Q_, des_r_leg_Q_,
                                            des_body_Q_);
    ...
    if (mov_step_ == mov_size_ - 1) {
      ROS_INFO("[END] Walking Control (%d/%d)", walking_step_ + 1,
               walking_size_);
...
void OnlineWalkingModule::initFeedforwardControl() {
  ...
  feed_forward_tra_ = new humanoid_robot_intelligence_control_system_framework::MinimumJerkViaPoint(
...
void OnlineWalkingModule::calcRobotPose() {
  ...
  Eigen::MatrixXd des_body_rot =
      humanoid_robot_intelligence_control_system_framework::convertQuaternionToRotation(des_body_Q);

  // Forward Kinematics
  humanoid_robot_intelligence_control_system_kdl_->initialize(des_body_pos, des_body_rot);
  ...
  humanoid_robot_intelligence_control_system_kdl_->setJointPosition(r_leg_joint_pos, l_leg_joint_pos);
  ...
  humanoid_robot_intelligence_control_system_kdl_->solveForwardKinematics(r_leg_pos, r_leg_Q, l_leg_pos, l_leg_Q);

  Eigen::Quaterniond curr_r_leg_Q(r_leg_Q[3], r_leg_Q[0], r_leg_Q[1],
                                  r_leg_Q[2]);
  Eigen::MatrixXd curr_r_leg_rot =
      humanoid_robot_intelligence_control_system_framework::convertQuaternionToRotation(curr_r_leg_Q);
  ...
  Eigen::MatrixXd curr_l_leg_rot =
      humanoid_robot_intelligence_control_system_framework::convertQuaternionToRotation(curr_l_leg_Q);
  ...
  humanoid_robot_intelligence_control_system_kdl_->finalize();
}
...
void OnlineWalkingModule::setBalanceControlGain() {
  //// set gain
  // gyro
  balance_control_.foot_roll_gyro_ctrl_.p_gain_ =
      foot_roll_gyro_p_gain_ * des_balance_gain_ratio_[0];
  balance_control_.foot_roll_gyro_ctrl_.d_gain_ =
      foot_roll_gyro_d_gain_ * des_balance_gain_ratio_[0];
  balance_control_.foot_pitch_gyro_ctrl_.p_gain_ =
      foot_pitch_gyro_p_gain_ * des_balance_gain_ratio_[0];
  balance_control_.foot_pitch_gyro_ctrl_.d_gain_ =
      foot_pitch_gyro_d_gain_ * des_balance_gain_ratio_[0];

  // orientation
  balance_control_.foot_roll_angle_ctrl_.p_gain_ =
      foot_roll_angle_p_gain_ * des_balance_gain_ratio_[0];
  balance_control_.foot_roll_angle_ctrl_.d_gain_ =
      foot_roll_angle_d_gain_ * des_balance_gain_ratio_[0];
  balance_control_.foot_pitch_angle_ctrl_.p_gain_ =
      foot_pitch_angle_p_gain_ * des_balance_gain_ratio_[0];
  balance_control_.foot_pitch_angle_ctrl_.d_gain_ =
      foot_pitch_angle_d_gain_ * des_balance_gain_ratio_[0];

  // force torque
  balance_control_.right_foot_force_x_ctrl_.p_gain_ =
      foot_x_force_p_gain_ * des_balance_gain_ratio_[0];
  balance_control_.right_foot_force_y_ctrl_.p_gain_ =
      foot_y_force_p_gain_ * des_balance_gain_ratio_[0];
  balance_control_.right_foot_force_z_ctrl_.p_gain_ =
      foot_z_force_p_gain_ * des_balance_gain_ratio_[0];
  balance_control_.right_foot_torque_roll_ctrl_.p_gain_ =
      foot_roll_torque_p_gain_ * des_balance_gain_ratio_[0];
  balance_control_.right_foot_torque_pitch_ctrl_.p_gain_ =
      foot_roll_torque_p_gain_ * des_balance_gain_ratio_[0];
  balance_control_.right_foot_force_x_ctrl_.d_gain_ =
      foot_x_force_d_gain_ * des_balance_gain_ratio_[0];
  balance_control_.right_foot_force_y_ctrl_.d_gain_ =
      foot_y_force_d_gain_ * des_balance_gain_ratio_[0];
  balance_control_.right_foot_force_z_ctrl_.d_gain_ =
      foot_z_force_d_gain_ * des_balance_gain_ratio_[0];
  balance_control_.right_foot_torque_roll_ctrl_.d_gain_ =
      foot_roll_torque_d_gain_ * des_balance_gain_ratio_[0];
  balance_control_.right_foot_torque_pitch_ctrl_.d_gain_ =
      foot_roll_torque_d_gain_ * des_balance_gain_ratio_[0];

  balance_control_.left_foot_force_x_ctrl_.p_gain_ =
      foot_x_force_p_gain_ * des_balance_gain_ratio_[0];
  balance_control_.left_foot_force_y_ctrl_.p_gain_ =
      foot_y_force_p_gain_ * des_balance_gain_ratio_[0];
  balance_control_.left_foot_force_z_ctrl_.p_gain_ =
      foot_z_force_p_gain_ * des_balance_gain_ratio_[0];
  balance_control_.left_foot_torque_roll_ctrl_.p_gain_ =
      foot_roll_torque_p_gain_ * des_balance_gain_ratio_[0];
  balance_control_.left_foot_torque_pitch_ctrl_.p_gain_ =
      foot_roll_torque_p_gain_ * des_balance_gain_ratio_[0];
  balance_control_.left_foot_force_x_ctrl_.d_gain_ =
      foot_x_force_d_gain_ * des_balance_gain_ratio_[0];
  balance_control_.left_foot_force_y_ctrl_.d_gain_ =
      foot_y_force_d_gain_ * des_balance_gain_ratio_[0];
  balance_control_.left_foot_force_z_ctrl_.d_gain_ =
      foot_z_force_d_gain_ * des_balance_gain_ratio_[0];
  balance_control_.left_foot_torque_roll_ctrl_.d_gain_ =
      foot_roll_torque_d_gain_ * des_balance_gain_ratio_[0];
  balance_control_.left_foot_torque_pitch_ctrl_.d_gain_ =
      foot_roll_torque_d_gain_ * des_balance_gain_ratio_[0];

  //// set cut off freq
  balance_control_.roll_gyro_lpf_.setCutOffFrequency(
      roll_gyro_cut_off_frequency_);
  balance_control_.pitch_gyro_lpf_.setCutOffFrequency(
      pitch_gyro_cut_off_frequency_);
  balance_control_.roll_angle_lpf_.setCutOffFrequency(
      roll_angle_cut_off_frequency_);
  balance_control_.pitch_angle_lpf_.setCutOffFrequency(
      pitch_angle_cut_off_frequency_);

  balance_control_.right_foot_force_x_lpf_.setCutOffFrequency(
      foot_x_force_cut_off_frequency_);
  balance_control_.right_foot_force_y_lpf_.setCutOffFrequency(
      foot_y_force_cut_off_frequency_);
  balance_control_.right_foot_force_z_lpf_.setCutOffFrequency(
      foot_z_force_cut_off_frequency_);
  balance_control_.right_foot_torque_roll_lpf_.setCutOffFrequency(
      foot_roll_torque_cut_off_frequency_);
  balance_control_.right_foot_torque_pitch_lpf_.setCutOffFrequency(
      foot_pitch_torque_cut_off_frequency_);

  balance_control_.left_foot_force_x_lpf_.setCutOffFrequency(
      foot_x_force_cut_off_frequency_);
  balance_control_.left_foot_force_y_lpf_.setCutOffFrequency(
      foot_y_force_cut_off_frequency_);
  balance_control_.left_foot_force_z_lpf_.setCutOffFrequency(
      foot_z_force_cut_off_frequency_);
  balance_control_.left_foot_torque_roll_lpf_.setCutOffFrequency(
      foot_roll_torque_cut_off_frequency_);
  balance_control_.left_foot_torque_pitch_lpf_.setCutOffFrequency(
      foot_pitch_torque_cut_off_frequency_);
}
...
bool OnlineWalkingModule::setBalanceControl() {
  ...
  balance_control_.setCOBManualAdjustment(
      des_body_offset_[0], des_body_offset_[1], des_body_offset_[2]);
  ...
  Eigen::MatrixXd des_body_rpy =
      humanoid_robot_intelligence_control_system_framework::convertQuaternionToRPY(des_body_Q);
  ...
  Eigen::MatrixXd des_r_foot_rot =
      humanoid_robot_intelligence_control_system_framework::convertQuaternionToRotation(des_r_foot_Q);
  ...
  Eigen::MatrixXd des_l_foot_rot =
      humanoid_robot_intelligence_control_system_framework::convertQuaternionToRotation(des_l_foot_Q);
  ...
  balance_control_.setCurrentGyroSensorOutput(imu_data_msg_.angular_velocity.x,
                                              imu_data_msg_.angular_velocity.y);
  ...
  Eigen::MatrixXd imu_rpy = humanoid_robot_intelligence_control_system_framework::convertRotationToRPY(
      humanoid_robot_intelligence_control_system_framework::getRotationX(M_PI) *
      imu_quaternion.toRotationMatrix() *
      humanoid_robot_intelligence_control_system_framework::getRotationZ(M_PI));
  ...
  Eigen::MatrixXd robot_to_r_foot_force =
      ...
      humanoid_robot_intelligence_control_system_framework::getRotationX(M_PI) *
      humanoid_robot_intelligence_control_system_framework::getTransitionXYZ(r_foot_ft_data_msg_.force.x,
  ...
  Eigen::MatrixXd robot_to_r_foot_torque =
      robot_to_r_foot.block(0, 0, 3, 3) *
      humanoid_robot_intelligence_control_system_framework::getRotationX(M_PI) *
      humanoid_robot_intelligence_control_system_framework::getTransitionXYZ(r_foot_ft_data_msg_.torque.x,
  ...
  Eigen::MatrixXd robot_to_l_foot_force =
      ...
      humanoid_robot_intelligence_control_system_framework::getRotationX(M_PI) *
      humanoid_robot_intelligence_control_system_framework::getTransitionXYZ(l_foot_ft_data_msg_.force.x,
  ...
  Eigen::MatrixXd robot_to_l_foot_torque =
      robot_to_l_foot.block(0, 0, 3, 3) *
      humanoid_robot_intelligence_control_system_framework::getRotationX(M_PI) *
      humanoid_robot_intelligence_control_system_framework::getTransitionXYZ(l_foot_ft_data_msg_.torque.x,
                                          l_foot_ft_data_msg_.torque.y,
                                          l_foot_ft_data_msg_.torque.z);

  balance_control_.setCurrentOrientationSensorOutput(imu_rpy.coeff(0, 0),
                                                     imu_rpy.coeff(1, 0));

  balance_control_.setCurrentFootForceTorqueSensorOutput(
      robot_to_r_foot_force.coeff(0, 0), robot_to_r_foot_force.coeff(1, 0),
      robot_to_r_foot_force.coeff(2, 0), robot_to_r_foot_torque.coeff(0, 0),
      robot_to_r_foot_torque.coeff(1, 0), robot_to_r_foot_torque.coeff(2, 0),
      robot_to_l_foot_force.coeff(0, 0), robot_to_l_foot_force.coeff(1, 0),
      robot_to_l_foot_force.coeff(2, 0), robot_to_l_foot_torque.coeff(0, 0),
      robot_to_l_foot_torque.coeff(1, 0), robot_to_l_foot_torque.coeff(2, 0));

  balance_control_.setDesiredCOBGyro(0.0, 0.0);

  balance_control_.setDesiredCOBOrientation(des_body_rpy.coeff(0, 0),
                                            des_body_rpy.coeff(1, 0));

  balance_control_.setDesiredFootForceTorque(
      balance_r_foot_force_x_, balance_r_foot_force_y_, balance_r_foot_force_z_,
      balance_r_foot_torque_x_, balance_r_foot_torque_y_,
      balance_r_foot_torque_z_, balance_l_foot_force_x_,
      balance_l_foot_force_y_, balance_l_foot_force_z_,
      balance_l_foot_torque_x_, balance_l_foot_torque_y_,
      balance_l_foot_torque_z_);

  balance_control_.setDesiredPose(robot_to_body, robot_to_r_foot,
                                  robot_to_l_foot);

  int error;
  Eigen::MatrixXd robot_to_body_mod, robot_to_r_foot_mod, robot_to_l_foot_mod;
  balance_control_.process(&error, &robot_to_body_mod, &robot_to_r_foot_mod,
                           &robot_to_l_foot_mod);
  ...
  // ======= ======= //
  humanoid_robot_intelligence_control_system_kdl_->initialize(des_body_pos_mod, des_body_rot_mod);
  ...
  Eigen::Quaterniond des_r_foot_Q_mod =
      humanoid_robot_intelligence_control_system_framework::convertRotationToQuaternion(des_r_foot_rot_mod);
  Eigen::Quaterniond des_l_foot_Q_mod =
      humanoid_robot_intelligence_control_system_framework::convertRotationToQuaternion(des_l_foot_rot_mod);

  ik_success = humanoid_robot_intelligence_control_system_kdl_->solveInverseKinematics(
...
void OnlineWalkingModule::setFeedforwardControl() {
  ...
  std::vector<double_t> feed_forward_value =
      feed_forward_tra_->getPosition(cur_time);
  ...
  for (int i = 0; i < number_of_joints_; i++)
    des_joint_feedforward_[i] = joint_feedforward_gain_[i] *
                                feed_forward_value[0] * support_leg_gain[i];
}
...
void OnlineWalkingModule::sensoryFeedback(const double &rlGyroErr,
  ...
  balance_angle[joint_name_to_id_["r_ank_pitch"] - 1] =
      -1.0 * internal_gain * fbGyroErr *
      balance_ankle_pitch_gain_; // R_ANKLE_PITCH
  balance_angle[joint_name_to_id_["l_ank_pitch"] - 1] =
      1.0 * internal_gain * fbGyroErr *
      balance_ankle_pitch_gain_; // L_ANKLE_PITCH

  balance_angle[joint_name_to_id_["r_ank_roll"] - 1] =
      -1.0 * internal_gain * rlGyroErr *
      balance_ankle_roll_gain_; // R_ANKLE_ROLL
  balance_angle[joint_name_to_id_["l_ank_roll"] - 1] =
      -1.0 * internal_gain * rlGyroErr *
      balance_ankle_roll_gain_; // L_ANKLE_ROLL
}

void OnlineWalkingModule::process(
    std::map<std::string, humanoid_robot_intelligence_control_system_framework::Dynamixel *> dxls,
  ...
  /*----- write curr position -----*/
  for (std::map<std::string, humanoid_robot_intelligence_control_system_framework::DynamixelState *>::iterator
           state_iter = result_.begin();
       state_iter != result_.end(); state_iter++) {
    std::string joint_name = state_iter->first;

    humanoid_robot_intelligence_control_system_framework::Dynamixel *dxl = NULL;
    std::map<std::string, humanoid_robot_intelligence_control_system_framework::Dynamixel *>::iterator dxl_it =
  ...
  for (std::map<std::string, humanoid_robot_intelligence_control_system_framework::DynamixelState *>::iterator
    ...
    result_[joint_name]->goal_position_ =
        des_joint_pos_to_robot_[joint_name_to_id_[joint_name] - 1];

    goal_joint_msg.name.push_back(joint_name);
    goal_joint_msg.position.push_back(
        des_joint_pos_[joint_name_to_id_[joint_name] - 1]);
  }
...
void OnlineWalkingModule::publishStatusMsg(unsigned int type, std::string msg) {
  humanoid_robot_intelligence_control_system_controller_msgs::StatusMsg status;
...
bool OnlineWalkingModule::getJointPoseCallback(
    humanoid_robot_intelligence_control_system_online_walking_module_msgs::GetJointPose::Request &req,
    humanoid_robot_intelligence_control_system_online_walking_module_msgs::GetJointPose::Response &res) {
  for (int i = 0; i < number_of_joints_; i++) {
...
bool OnlineWalkingModule::getKinematicsPoseCallback(
    humanoid_robot_intelligence_control_system_online_walking_module_msgs::GetKinematicsPose::Request &req,
    humanoid_robot_intelligence_control_system_online_walking_module_msgs::GetKinematicsPose::Response &res) {
