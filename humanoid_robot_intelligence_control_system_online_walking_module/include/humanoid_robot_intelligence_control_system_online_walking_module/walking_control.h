...
#ifndef HUMANOID_ROBOT_ONLINE_WALKING_MODULE_WALKING_CONTROL_
#define HUMANOID_ROBOT_ONLINE_WALKING_MODULE_WALKING_CONTROL_

#pragma once

#include "humanoid_robot_intelligence_control_system_online_walking_module_msgs/FootStepArray.h"
...
public:
  ...
  void
  initialize(humanoid_robot_intelligence_control_system_online_walking_module_msgs::FootStepCommand foot_step_command,
  ...
  void initialize(humanoid_robot_intelligence_control_system_online_walking_module_msgs::Step2DArray foot_step_2d,
                  std::vector<double_t> init_body_pos,
                  std::vector<double_t> init_body_Q,
                  std::vector<double_t> init_r_foot_pos,
                  std::vector<double_t> init_r_foot_Q,
...
protected:
  ...
  humanoid_robot_intelligence_control_system_framework::MinimumJerk *body_trajectory_;
  humanoid_robot_intelligence_control_system_framework::MinimumJerkViaPoint *r_foot_tra_;
  humanoid_robot_intelligence_control_system_framework::MinimumJerkViaPoint *l_foot_tra_;

  humanoid_robot_intelligence_control_system_framework::PreviewControl *preview_control_;
  ...
  humanoid_robot_intelligence_control_system_online_walking_module_msgs::FootStepArray foot_step_param_;
