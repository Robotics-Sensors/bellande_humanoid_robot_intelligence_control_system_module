...
#include "humanoid_robot_intelligence_control_system_kdl.h"
...
#include "humanoid_robot_intelligence_control_system_online_walking_module_msgs/FootStepCommand.h"
#include "humanoid_robot_intelligence_control_system_online_walking_module_msgs/JointPose.h"
#include "humanoid_robot_intelligence_control_system_online_walking_module_msgs/KinematicsPose.h"
#include "humanoid_robot_intelligence_control_system_online_walking_module_msgs/PreviewRequest.h"
#include "humanoid_robot_intelligence_control_system_online_walking_module_msgs/PreviewResponse.h"
#include "humanoid_robot_intelligence_control_system_online_walking_module_msgs/WalkingParam.h"

#include "humanoid_robot_intelligence_control_system_online_walking_module_msgs/GetJointPose.h"
#include "humanoid_robot_intelligence_control_system_online_walking_module_msgs/GetKinematicsPose.h"
#include "humanoid_robot_intelligence_control_system_online_walking_module_msgs/GetPreviewMatrix.h"

#include "humanoid_robot_intelligence_control_system_online_walking_module_msgs/Step2D.h"
#include "humanoid_robot_intelligence_control_system_online_walking_module_msgs/Step2DArray.h"
...
class OnlineWalkingModule
    : public humanoid_robot_intelligence_control_system_framework::MotionModule,
      public humanoid_robot_intelligence_control_system_framework::Singleton<OnlineWalkingModule> {
public:
  OnlineWalkingModule();
  ...
  void
  goalJointPoseCallback(const humanoid_robot_intelligence_control_system_online_walking_module_msgs::JointPose &msg);
  void goalKinematicsPoseCallback(
      const humanoid_robot_intelligence_control_system_online_walking_module_msgs::KinematicsPose &msg);
  void footStepCommandCallback(
      const humanoid_robot_intelligence_control_system_online_walking_module_msgs::FootStepCommand &msg);
  void
  walkingParamCallback(const humanoid_robot_intelligence_control_system_online_walking_module_msgs::WalkingParam &msg);

  void
  footStep2DCallback(const humanoid_robot_intelligence_control_system_online_walking_module_msgs::Step2DArray &msg);

  void imuDataCallback(const sensor_msgs::Imu::ConstPtr &msg);
  void leftFootForceTorqueOutputCallback(
      const geometry_msgs::WrenchStamped::ConstPtr &msg);
  void rightFootForceTorqueOutputCallback(
      const geometry_msgs::WrenchStamped::ConstPtr &msg);
  ...
  bool getPreviewMatrix(humanoid_robot_intelligence_control_system_online_walking_module_msgs::PreviewRequest msg);
  ...
  HUMANOID_ROBOTKinematics *humanoid_robot_intelligence_control_system_kdl_;
...
private:
  ...
  humanoid_robot_intelligence_control_system_framework::MinimumJerk *joint_tra_;
  humanoid_robot_intelligence_control_system_framework::MinimumJerk *balance_tra_;
  humanoid_robot_intelligence_control_system_framework::MinimumJerk *body_offset_tra_;
  humanoid_robot_intelligence_control_system_framework::MinimumJerkViaPoint *feed_forward_tra_;
  ...
  std::vector<double_t> des_l_arm_pos_, des_l_arm_vel_, des_l_arm_accel_,
      des_l_arm_Q_;
  std::vector<double_t> des_r_arm_pos_, des_r_arm_vel_, des_r_arm_accel_,
      des_r_arm_Q_;
  std::vector<double_t> des_l_leg_pos_, des_l_leg_vel_, des_l_leg_accel_,
      des_l_leg_Q_;
  std::vector<double_t> des_r_leg_pos_, des_r_leg_vel_, des_r_leg_accel_,
      des_r_leg_Q_;
  ...
  humanoid_robot_intelligence_control_system_online_walking_module_msgs::FootStepCommand foot_step_command_;
  humanoid_robot_intelligence_control_system_online_walking_module_msgs::PreviewRequest preview_request_;
  humanoid_robot_intelligence_control_system_online_walking_module_msgs::PreviewResponse preview_response_;
  humanoid_robot_intelligence_control_system_online_walking_module_msgs::WalkingParam walking_param_;

  humanoid_robot_intelligence_control_system_online_walking_module_msgs::Step2DArray foot_step_2d_;
