...
#ifndef HUMANOID_ROBOT_ONLINE_WALKING_MODULE_WHOLEBODY_CONTROL_
#define HUMANOID_ROBOT_ONLINE_WALKING_MODULE_WHOLEBODY_CONTROL_
...
public:
  WholebodyControl(std::string control_group, double init_time, double fin_time,
                   geometry_msgs::Pose goal_msg);
  virtual ~WholebodyControl();

  void initialize(std::vector<double_t> init_body_pos,
...
private:
  humanoid_robot_intelligence_control_system_framework::MinimumJerk *task_trajectory_;
