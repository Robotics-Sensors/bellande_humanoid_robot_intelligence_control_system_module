...
OnlineWalkingModule::OnlineWalkingModule()
  ...
  std::string balance_gain_path =
      ros::package::getPath("op3_online_walking_module") +
...
void OnlineWalkingModule::walkingParamCallback(
    const op3_online_walking_module_msgs::WalkingParam &msg) {
  walking_param_ = msg;
}

void OnlineWalkingModule::goalJointPoseCallback(
    const op3_online_walking_module_msgs::JointPose &msg) {
  if (enable_ == false)
    return;
...
void OnlineWalkingModule::goalKinematicsPoseCallback(
    const op3_online_walking_module_msgs::KinematicsPose &msg) {
  if (enable_ == false)
    return;
...
void OnlineWalkingModule::footStep2DCallback(
    const op3_online_walking_module_msgs::Step2DArray &msg) {
  if (enable_ == false)
    return;
...
void OnlineWalkingModule::footStepCommandCallback(
    const op3_online_walking_module_msgs::FootStepCommand &msg) {
  if (enable_ == false)
    return;
...
bool OnlineWalkingModule::setBalanceControl() {
  ...
  ik_success = op3_kdl_->solveInverseKinematics(
...
bool OnlineWalkingModule::getJointPoseCallback(
    op3_online_walking_module_msgs::GetJointPose::Request &req,
...
bool OnlineWalkingModule::getKinematicsPoseCallback(
    op3_online_walking_module_msgs::GetKinematicsPose::Request &req,
