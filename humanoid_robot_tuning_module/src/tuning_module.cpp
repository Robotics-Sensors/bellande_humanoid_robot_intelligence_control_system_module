...
void TuningModule::moveToTunePose(const std::string &pose_name) {
  if (enable_ == false) {
    ROS_ERROR("humanoid_robot_tuning_module is not enable!!");
    return;
  }
...
void TuningModule::jointOffsetDataCallback(
    const humanoid_robot_tuning_module_msgs::JointOffsetData::ConstPtr &msg) {
...
bool TuningModule::getPresentJointOffsetDataServiceCallback(
    humanoid_robot_tuning_module_msgs::GetPresentJointOffsetData::Request &req,
    humanoid_robot_tuning_module_msgs::GetPresentJointOffsetData::Response &res) {
  ...
  for (std::map<std::string, JointOffsetData *>::iterator map_it =
    ...
    humanoid_robot_tuning_module_msgs::JointOffsetPositionData joint_offset_pos;
