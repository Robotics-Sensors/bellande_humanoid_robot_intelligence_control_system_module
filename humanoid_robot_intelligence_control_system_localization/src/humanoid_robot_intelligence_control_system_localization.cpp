...
void HUMANOID_ROBOTLocalization::initialize() {
  ...
  pelvis_pose_msg_sub_ = ros_node_.subscribe(
      "/humanoid_robot_intelligence_control_system/pelvis_pose", 5, &HUMANOID_ROBOTLocalization::pelvisPoseCallback, this);
  //  pelvis_base_walking_msg_sub_ =
  //  ros_node_.subscribe("/humanoid_robot_intelligence_control_system/pelvis_pose_base_walking", 5,
  //                                                               &HUMANOID_ROBOTLocalization::pelvisPoseBaseWalkingCallback,
  //                                                               this);

  pelvis_reset_msg_sub_ =
      ros_node_.subscribe("/humanoid_robot_intelligence_control_system/pelvis_pose_reset", 5,
...
//  Eigen::MatrixXd rpy = humanoid_robot_intelligence_control_system_framework::convertQuaternionToRPY(msg_q);
...
//      Eigen::Quaterniond
//      pose_old_quaternion(pelvis_pose_old_.pose.orientation.w,
//                                             pelvis_pose_old_.pose.orientation.x,
//                                             pelvis_pose_old_.pose.orientation.y,
//                                             pelvis_pose_old_.pose.orientation.z);

//      Eigen::Quaterniond
//      pose_base_quaternion(pelvis_pose_base_walking_.pose.orientation.w,
...
void HUMANOID_ROBOTLocalization::process() {
  ...
  tf::Quaternion q(
      pelvis_pose_.pose.orientation.x, pelvis_pose_.pose.orientation.y,
      pelvis_pose_.pose.orientation.z, pelvis_pose_.pose.orientation.w);

  pelvis_trans_.setRotation(q);

  ros::Duration transform_tolerance(transform_tolerance_);
  ros::Time transform_expiration =
      (pelvis_pose_.header.stamp + transform_tolerance);

  tf::StampedTransform tmp_tf_stamped(pelvis_trans_, transform_expiration,
                                      "world", "body_link");
...
void HUMANOID_ROBOTLocalization::update() {
  ...
  Eigen::Quaterniond pose_old_quaternion(
      pelvis_pose_old_.pose.orientation.w, pelvis_pose_old_.pose.orientation.x,
      pelvis_pose_old_.pose.orientation.y, pelvis_pose_old_.pose.orientation.z);

  //  Eigen::Quaterniond
  //  pose_base_walking_quaternion(pelvis_pose_base_walking_.pose.orientation.w,
  //                                                  pelvis_pose_base_walking_.pose.orientation.x,
  //                                                  pelvis_pose_base_walking_.pose.orientation.y,
  //                                                  pelvis_pose_base_walking_.pose.orientation.z);

  Eigen::Quaterniond pose_offset_quaternion(
      pelvis_pose_offset_.pose.orientation.w,
      pelvis_pose_offset_.pose.orientation.x,
      pelvis_pose_offset_.pose.orientation.y,
      pelvis_pose_offset_.pose.orientation.z);

  Eigen::Quaterniond pose_quaternion = pose_old_quaternion *
  ...
  Eigen::MatrixXd orientation =
      humanoid_robot_intelligence_control_system_framework::convertQuaternionToRotation(pose_old_quaternion);
  ...
  //  pelvis_pose_base_walking_new_.pose.position.x =
  //  position_walking_new.coeff(0,0);
  //  pelvis_pose_base_walking_new_.pose.position.y =
  //  position_walking_new.coeff(1,0);
