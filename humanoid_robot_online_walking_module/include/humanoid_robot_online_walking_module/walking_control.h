...
#include "humanoid_robot_online_walking_module_msgs/FootStepArray.h"
...
public:
  ...
  void
  initialize(humanoid_robot_online_walking_module_msgs::FootStepCommand foot_step_command,
  ...
  void initialize(humanoid_robot_online_walking_module_msgs::Step2DArray foot_step_2d,
                  std::vector<double_t> init_body_pos,
                  std::vector<double_t> init_body_Q,
                  std::vector<double_t> init_r_foot_pos,
                  std::vector<double_t> init_r_foot_Q,
...
protected:
  ...
  humanoid_robot_online_walking_module_msgs::FootStepArray foot_step_param_;
