...
#include "humanoid_robot_online_walking_module_msgs/KinematicsPose.h"
#include "humanoid_robot_online_walking_module_msgs/PreviewRequest.h"
#include "humanoid_robot_online_walking_module_msgs/PreviewResponse.h"
#include "humanoid_robot_online_walking_module_msgs/WalkingParam.h"

#include "humanoid_robot_online_walking_module_msgs/GetJointPose.h"
#include "humanoid_robot_online_walking_module_msgs/GetKinematicsPose.h"
#include "humanoid_robot_online_walking_module_msgs/GetPreviewMatrix.h"
...
public:
  ...
  void
  goalJointPoseCallback(const humanoid_robot_online_walking_module_msgs::JointPose &msg);
  ...
  void
  walkingParamCallback(const humanoid_robot_online_walking_module_msgs::WalkingParam &msg);

  void
  footStep2DCallback(const humanoid_robot_online_walking_module_msgs::Step2DArray &msg);
  ...
  bool getPreviewMatrix(humanoid_robot_online_walking_module_msgs::PreviewRequest msg);
...
private:
  ...
  humanoid_robot_online_walking_module_msgs::FootStepCommand foot_step_command_;
  humanoid_robot_online_walking_module_msgs::PreviewRequest preview_request_;
  humanoid_robot_online_walking_module_msgs::PreviewResponse preview_response_;
  humanoid_robot_online_walking_module_msgs::WalkingParam walking_param_;

  humanoid_robot_online_walking_module_msgs::Step2DArray foot_step_2d_;
