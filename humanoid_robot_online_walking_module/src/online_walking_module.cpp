...
OnlineWalkingModule::OnlineWalkingModule()
  ...
  std::string balance_gain_path =
      ros::package::getPath("humanoid_robot_online_walking_module") +
...
void OnlineWalkingModule::walkingParamCallback(
    const humanoid_robot_online_walking_module_msgs::WalkingParam &msg) {
  walking_param_ = msg;
}

void OnlineWalkingModule::goalJointPoseCallback(
    const humanoid_robot_online_walking_module_msgs::JointPose &msg) {
  if (enable_ == false)
    return;
...
void OnlineWalkingModule::goalKinematicsPoseCallback(
    const humanoid_robot_online_walking_module_msgs::KinematicsPose &msg) {
  if (enable_ == false)
    return;
...
void OnlineWalkingModule::footStep2DCallback(
    const humanoid_robot_online_walking_module_msgs::Step2DArray &msg) {
  if (enable_ == false)
    return;
  ...
  humanoid_robot_online_walking_module_msgs::Step2DArray foot_step_msg;

  int old_size = msg.footsteps_2d.size();
  int new_size = old_size + 3;

  humanoid_robot_online_walking_module_msgs::Step2D first_msg;
  humanoid_robot_online_walking_module_msgs::Step2D second_msg;
  ...
  if (control_type_ == NONE || control_type_ == WALKING_CONTROL) {
    ...
    humanoid_robot_online_walking_module_msgs::Step2D step_msg =
...
void OnlineWalkingModule::footStepCommandCallback(
    const humanoid_robot_online_walking_module_msgs::FootStepCommand &msg) {
  if (enable_ == false)
    return;
...
void OnlineWalkingModule::calcRobotPose() {
  ...
  humanoid_robot_kdl_->setJointPosition(r_leg_joint_pos, l_leg_joint_pos);
  ...
  humanoid_robot_kdl_->solveForwardKinematics(r_leg_pos, r_leg_Q, l_leg_pos, l_leg_Q);
...
bool OnlineWalkingModule::setBalanceControl() {
  ...
  // ======= ======= //
  humanoid_robot_kdl_->initialize(des_body_pos_mod, des_body_rot_mod);
...
bool OnlineWalkingModule::getJointPoseCallback(
    humanoid_robot_online_walking_module_msgs::GetJointPose::Request &req,
    humanoid_robot_online_walking_module_msgs::GetJointPose::Response &res) {
  for (int i = 0; i < number_of_joints_; i++) {
...
bool OnlineWalkingModule::getKinematicsPoseCallback(
    humanoid_robot_online_walking_module_msgs::GetKinematicsPose::Request &req,
    humanoid_robot_online_walking_module_msgs::GetKinematicsPose::Response &res) {
