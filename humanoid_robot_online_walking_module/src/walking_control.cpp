...
#include "humanoid_robot_online_walking_module/walking_control.h"
#include <stdio.h>
...
void WalkingControl::initialize(
    humanoid_robot_online_walking_module_msgs::FootStepCommand foot_step_command,
...
void WalkingControl::initialize(
    humanoid_robot_online_walking_module_msgs::Step2DArray foot_step_2d,
    std::vector<double_t> init_body_pos, std::vector<double_t> init_body_Q,
    std::vector<double_t> init_r_foot_pos, std::vector<double_t> init_r_foot_Q,
    std::vector<double_t> init_l_foot_pos,
    std::vector<double_t> init_l_foot_Q) {
...
void WalkingControl::transformFootStep2D() {
  ...
  humanoid_robot_online_walking_module_msgs::FootStepArray foot_step_param;

  for (int step = 0; step < foot_step_size_; step++) {
    humanoid_robot_online_walking_module_msgs::Step2D msg =
